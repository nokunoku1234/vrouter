...
/// instead use VRouter as the topmost MaterialApp
/// DO use this in your widget instead of the traditional [MaterialApp]
/// Note that if you ever use [MaterialApp] instead of [VMaterialApp],
/// you risk breaking the entire navigation system.
class VMaterialApp<T extends Object> extends StatelessWidget {
  final Widget child;
